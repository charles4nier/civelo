...
export default async function Page() {
	...
	const Component = pickTheme(theme, { edito: StyleEditoDocumentsPage, app: AppDocumentsPage, accueillant: AccueillantDocumentsPage, classique: ClassiqueDocumentsPage });
	return <Component />;
}
