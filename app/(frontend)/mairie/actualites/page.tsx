...
export default async function Page() {
	...
	const Component = pickTheme(theme, { edito: StyleEditoActualitesPage, app: AppActualitesPage, accueillant: AccueillantActualitesPage, classique: ClassiqueActualitesPage });
	return <Component />;
}
