...
export default async function Page() {
	...
	const Component = pickTheme(theme, { edito: StyleEditoDemarchesPage, app: AppDemarchesPage, accueillant: AccueillantDemarchesPage, classique: ClassiqueDemarchesPage });
	return <Component />;
}
