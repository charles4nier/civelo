...
import ContactCard, { type ContactItem, type IconVariant } from '@themes/atelier/components/ContactCard';
import Breadcrumb from '@themes/atelier/components/Breadcrumb';
