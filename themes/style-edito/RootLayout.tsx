...
import '@themes/style-edito/styles/index.scss';

import Header from '@themes/style-edito/components/Header';
import Footer from '@themes/style-edito/components/Footer';
import FloatingButtons from '@themes/style-edito/components/FloatingButtons';
