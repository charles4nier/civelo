...
import ContactCard, { type ContactItem, type IconVariant } from '@themes/style-edito/components/ContactCard';
import Breadcrumb from '@themes/style-edito/components/Breadcrumb';
