...
const locaux = [
	{ label: 'Mairie de la commune',    number: '00 00 00 00 00', detail: 'Lun – Ven : 9h – 12h / 14h – 17h', href: 'tel:+330000000000' },
	{ label: 'Gendarmerie locale',      number: '00 00 00 00 00', detail: null,                                  href: 'tel:+330000000000' },
	{ label: 'Centre hospitalier',      number: '00 00 00 00 00', detail: null,                                  href: 'tel:+330000000000' },
];
				...
				<div className={`${CLASS_NAME}__inner container`}>
					...
					<div className={`${CLASS_NAME}__block`}>
						...
						<div className={`${CLASS_NAME}__urgences`}>
							{urgences.map((u) => (
								<a key={u.number} href={`tel:${u.number}`} className={`${CLASS_NAME}__urgence ${CLASS_NAME}__urgence--${u.color}`}>
