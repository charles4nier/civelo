import AnnuaireLayout, { type AnnuaireCardData } from '@themes/preau/components/AnnuaireLayout';
import type { IconVariant } from '@themes/preau/components/ContactCard';
